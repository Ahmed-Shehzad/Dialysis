...
public sealed class RabbitMqTransportTests
{
    ...
    [Fact]
    public void RabbitMqHostSettings_Requires_Host() => _ = Assert.Throws<ArgumentException>(() => new RabbitMqHostSettings(new Uri("rabbitmq://broker"), new RabbitMqConnectionSettings(" ")));
