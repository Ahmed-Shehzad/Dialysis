...
namespace Dialysis.PDMS.Contracts.Messaging;

/// <summary>
/// Maps PDMS <see cref="IIntegrationEvent"/> instances to <see cref="TransponderOutboxEnvelope"/> for the shared Transponder transactional outbox.
/// </summary>
public static class PdmsTransponderOutboxEnvelope
{
