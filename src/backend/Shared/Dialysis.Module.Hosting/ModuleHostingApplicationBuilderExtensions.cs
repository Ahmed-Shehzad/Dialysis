...
{
    /// <summary>
    /// Wires the standard module middleware pipeline: global exception handler (incl. problem-details),
    /// correlation id, authentication (when configured), authorization, and the live/ready health endpoints.
