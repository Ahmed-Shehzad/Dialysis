...
public sealed class PatientMapper :
    IFhirMapper<PatientRegisteredIntegrationEvent, Patient>,
    IFhirMapper<PatientDemographicsUpdatedIntegrationEvent, Patient>,
    IFhirMapper<PatientsMergedIntegrationEvent, Patient>
{
