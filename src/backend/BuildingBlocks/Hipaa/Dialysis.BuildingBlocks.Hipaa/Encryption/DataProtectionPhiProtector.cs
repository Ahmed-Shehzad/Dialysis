...
/// </summary>
public sealed class DataProtectionPhiProtector(IDataProtectionProvider provider) : IPhiProtector
{
    ...
    private readonly IDataProtector _protector = provider.CreateProtector(PurposeV1);
