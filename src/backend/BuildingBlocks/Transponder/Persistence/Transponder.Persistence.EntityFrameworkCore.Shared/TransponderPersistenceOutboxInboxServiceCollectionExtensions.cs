...
public static class TransponderPersistenceOutboxInboxServiceCollectionExtensions
{
    extension(IServiceCollection services)
    {
        ...
        /// </summary>
        public IServiceCollection AddTransponderEfOutboxAndInbox<TContext>()
        ...
        /// </summary>
        public IServiceCollection AddTransponderOutboxRelay<TContext>(Action<TransponderOutboxRelayOptions>? configure = null)
            where TContext : TransponderPersistenceDbContextBase
        {
