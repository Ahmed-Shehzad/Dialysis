...
public static class TransponderPersistenceServiceCollectionExtensions
{
    extension(IServiceCollection services)
    {
        ...
        /// </summary>
        public IServiceCollection AddTransponderPostgreSqlPersistence(IConfiguration configuration,
        ...
        /// </summary>
        public IServiceCollection AddTransponderPostgreSqlPersistence(Action<TransponderPersistenceOptions> configure)
        {
        ...
        /// </summary>
        public IServiceCollection AddTransponderPostgreSqlPersistence(string connectionString,
            string schema)
        {
