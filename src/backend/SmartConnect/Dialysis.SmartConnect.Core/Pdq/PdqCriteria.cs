...
public sealed record PdqCriteria
{
    ...
    /// </list>
    /// </remarks>
    public PdqCriteria(string QueryTag,
    ...
    public void Deconstruct(out string QueryTag, out string MessageControlId, out string? MedicalRecordNumber, out string? PersonNumber, out string? FamilyName, out string? GivenName)
    {
