...
/// <summary>
/// Transponder receive endpoint that deserializes messages and dispatches to <see cref="IMessageHandler{TMessage}"/>.
/// </summary>
internal sealed class MessageConsumerEndpoint<TMessage> : IReceiveEndpoint
    where TMessage : class, IMessage
{
    ...
    private readonly ILogger<MessageConsumerEndpoint<TMessage>> _logger;
    private IReceiveEndpoint? _inner;

    public MessageConsumerEndpoint(
        IOptions<MessageConsumerOptions<TMessage>> options,
        ITransportHostProvider hostProvider,
        IMessageSerializer serializer,
        IServiceScopeFactory scopeFactory,
        ILogger<MessageConsumerEndpoint<TMessage>> logger)
    {
    ...
    private async Task HandleAsync(IReceiveContext context)
    {
        ...
        {
            _logger.LogWarning(
                "MessageConsumerEndpoint deserialized to {ActualType}, expected {ExpectedType}",
        ...
        {
            _logger.LogWarning(
                "No IMessageHandler<{MessageType}> registered",
