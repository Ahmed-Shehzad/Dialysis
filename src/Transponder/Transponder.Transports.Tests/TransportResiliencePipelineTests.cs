...
public sealed class TransportResiliencePipelineTests
{
    ...
    public void Create_Returns_Empty_When_Disabled()
    {
        ...
        var pipeline = TransportResiliencePipeline.Create(options);
    ...
    public void WrapSend_Returns_Inner_For_Empty_Pipeline()
    {
        ...
        var wrapped = TransportResiliencePipeline.WrapSend(transport, ResiliencePipeline.Empty);
    ...
    public void WrapPublish_Returns_Inner_For_Empty_Pipeline()
    {
        ...
        var wrapped = TransportResiliencePipeline.WrapPublish(transport, ResiliencePipeline.Empty);
