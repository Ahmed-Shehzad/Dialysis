...
public static class SagaExecution
{
        ...
        where TState : class, ISagaState
    {
        ...
        catch
        {
            ...
            var compensationFailed = await CompensateStepsAsync(executedSteps, state, cancellationToken).ConfigureAwait(false);
        ...
        where TState : class, ISagaState
    {
        ...
        for (var index = executedSteps.Count - 1; index >= 0; index--)
            try
            {
