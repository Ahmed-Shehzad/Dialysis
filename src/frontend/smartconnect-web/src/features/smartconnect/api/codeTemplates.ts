...
const path = (id?: string) =>
  id ? `${ADMIN_PREFIX}/code-template-libraries/${id}` : `${ADMIN_PREFIX}/code-template-libraries`;
...
export const fetchCodeTemplateLibrary = async (id: string): Promise<CodeTemplateLibrary> => {
