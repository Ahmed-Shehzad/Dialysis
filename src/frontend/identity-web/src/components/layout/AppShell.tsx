...
// Single-context (Admin) navigation. Paths are absolute within the app's `/admin` router basename.
const ADMIN_NAV: ReadonlyArray<{ to: string; label: string }> = [
  { to: "/", label: "Hub" },
  { to: "/identity", label: "Identity" },
  { to: "/hipaa", label: "HIPAA" },
  { to: "/data-protection/ropa", label: "RoPA" },
  { to: "/data-protection/consents", label: "Consents" },
  { to: "/data-protection/data-subject-rights", label: "Subject rights" },
  { to: "/demo", label: "Demo" },
];
...
// Admin chrome. The top nav lists this context's views; cross-context navigation
      ...
      <header className="border-b border-slate-800 bg-slate-900/80 backdrop-blur">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
          <div className="flex items-center gap-6">
            <h1 className="text-lg font-semibold tracking-tight text-clinic-50">Dialysis · Admin</h1>
