...
test.describe("ehr-web — authenticated landing", () => {
  test("loads the ehr landing context for an authenticated user", async ({ page }) => {
    await stubRealtime(page);
    await stubApiCatchAll(page);
    await mockAuth(page, { permissions: ["ehr.patient_chart.view"] });
