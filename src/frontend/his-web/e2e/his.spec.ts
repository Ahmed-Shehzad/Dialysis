...
test.describe("his-web — authenticated landing", () => {
  test("loads the his landing context for an authenticated user", async ({ page }) => {
    await stubRealtime(page);
    await stubApiCatchAll(page);
    await mockAuth(page, { permissions: ["his.patient_access.view"] });
