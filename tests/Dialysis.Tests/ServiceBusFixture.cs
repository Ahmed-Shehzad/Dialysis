...
/// Note: The Azure Service Bus Emulator requires SQL Server/Azure SQL Edge as its internal backend storage.
/// This is a requirement of the emulator itself—not our application. Dialysis PDMS uses PostgreSQL for
/// all application data (alerting, subscriptions, audit). See PostgresFixture for app-level tests.
/// </summary>
public sealed class ServiceBusFixture : IAsyncLifetime
{
    ...
    public ServiceBusFixture()
    {
        ...
        // SQL Edge is required by the Azure Service Bus Emulator for its internal metadata storage.
        // This is not used for our application data; Dialysis uses PostgreSQL everywhere.
    ...
    public async Task InitializeAsync()
    {
        ...
        await Task.Delay(3000); // Allow emulator to fully settle
    }
