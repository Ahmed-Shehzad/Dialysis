...
{
    private const string MinimalQbpD01 = @"MSH|^~\&|MACH|FAC|EMR|FAC|20230215120000||QBP^D01^QBP_D01|MSG001|P|2.6
...
RCP|I||RD";
    ...
    {
        var result = new QbpD01Parser().Parse(MinimalQbpD01);
    ...
    {
        const string noMrn = @"MSH|^~\&|MACH|FAC|||20230215120000||QBP^D01^QBP_D01|MSG002|P|2.6
QPD|MDC_HDIALY_RX_QUERY^Hemodialysis Prescription Query^MDC|Q002|@PID.3|^^^^MR
RCP|I||RD";

        var ex = Should.Throw<ArgumentException>(() => new QbpD01Parser().Parse(noMrn));
