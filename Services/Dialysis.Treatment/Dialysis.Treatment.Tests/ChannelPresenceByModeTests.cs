...
public sealed class ChannelPresenceByModeTests
{
    ...
    {
        IReadOnlySet<int> channels = ChannelPresenceByMode.GetChannelsForMode(ModeOfOperation.Idle);
    ...
    {
        IReadOnlySet<int> channels = ChannelPresenceByMode.GetChannelsForMode(ModeOfOperation.Service);
        channels.ShouldBe([ChannelPresenceByMode.Machine]);
    }
    ...
    {
        IReadOnlySet<int> channels = ChannelPresenceByMode.GetChannelsForModality(TreatmentModality.Hemodialysis);
    ...
    {
        IReadOnlySet<int> channels = ChannelPresenceByMode.GetChannelsForModality(TreatmentModality.Hemodiafiltration);
    ...
    {
        IReadOnlySet<int> channels = ChannelPresenceByMode.GetChannelsForModality(TreatmentModality.Hemofiltration);
    ...
    {
        IReadOnlySet<int> channels = ChannelPresenceByMode.GetChannelsForModality(TreatmentModality.IsolatedUltrafiltration);
        channels.ShouldNotContain(ChannelPresenceByMode.Dialysate);
        channels.ShouldNotContain(ChannelPresenceByMode.Convective);
    }
